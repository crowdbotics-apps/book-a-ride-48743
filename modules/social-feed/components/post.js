...
export const PostComponent = ({
  ...
  return <KeyboardAwareScrollView style={_styles.WXSPTYzM}>
      <View style={styles.postDetailsContainer}>
        ...
        <View style={_styles.wEpNtfcO}>
          ...
          setTimeout(() => {
            ...
            <Image source={require("../assets/dots.png")} style={_styles.rLqDyJkc} />
          </TouchableOpacity>
        </View>
      </View>
      {
      ...
      <View style={styles.postcontainer}>
        <View style={styles.leftContainer}>
          ...
          <TouchableOpacity style={_styles.tPvHqDra}>
