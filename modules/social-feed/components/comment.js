  ...
  return <View style={styles.commentMainContainer}>
      ...
      return <View style={styles.commentContainer} key={item.key}>
            ...
            navigation.navigate("SocialProfileScreen", {
              ...
              <View style={_styles.ySIczpUH}>
                <TouchableOpacity>
                  <Image source={require("../assets/dots.png")} style={_styles.YbmHpdPY} />
                </TouchableOpacity>
              </View>
            </View>
            ...
            return <View style={styles.commentReplyContainer} key={item.key}>
                  ...
                  navigation.navigate("SocialProfileScreen", {
                    id: item?.user?.id
                      ...
                      <View style={_styles.WcnmBltp}>
                        <TouchableOpacity>
                          <Image source={require("../assets/dots.png")} style={_styles.RxoYXSsZ} />
                        </TouchableOpacity>
                      </View>
                    </View>
                    ...
                    item.liked ? unLikePostComment(item.id) : likePostComment(item.id);
                        ...
                        <TouchableOpacity style={_styles.hAuVKZno} onPress={() => {
                    refComment.current = item?.id;
                    setComment("@" + item.user.name);
                  }}>
                          <Image source={require("../assets/group.png")} style={[styles.imageIcons, styles.mr10]} />
      ...
      <View style={styles.commentTextInput}>
        <TextInput style={[styles.replyInput, _styles.xFdvYooM]} placeholder="Add a comment" onChangeText={newText => setComment(newText)} defaultValue={comment} />
        <TouchableOpacity onPress={() => {
        submitComment();
