...
const SocialFeedScreen = props => {
  ...
  return <View style={_styles.lxaFDgLD}>
      <View style={styles.feedContainer}>
        <View style={_styles.bKyGhEFT}>
          {
          /* search bar */
        }
...
const PostComponent = ({
  ...
  return <TouchableOpacity style={_styles.FGfRoJwV} onPress={() => {
    navigationObject.navigate("PostDetailsScreen", {
      ...
      <View style={styles.postcontainer}>
        <View style={styles.leftContainer}>
          <TouchableOpacity style={_styles.deYrUNZs} onPress={() => {
